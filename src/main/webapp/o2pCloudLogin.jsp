...
<div class="page-container"> 
  ...
  <div class="row breadcrumbs" style="background: #0275b3;">
    <div class="container" >
      <div class="col-md-4 col-sm-4">
        <h1 style="color:#ffffff;">${local["eaap.op2.portal.login.toLogin"]}</h1>
      </div>
  ...
  <div class="container margin-bottom-40 mt30">
    <div class="panel-body row">
      <div class="col-md-7 loginLeftBg"></div>
      <div class="col-md-5" ><div class="col-md-12  col-sm-12 ">
        <form class="login-form" method="post">
          ...
          <div class="form-group">
            <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-ok"></i></span>
              <input id="rand" type="text" class="form-control" style="width:265px;" placeholder='${local["eaap.op2.portal.login.verification"]}' name="verification"  maxlength="4"  value="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <button type="submit" class="btn theme-btn pull-left" id="btnlogin">${local["eaap.op2.portal.login.toLogin"]}</button>
            </div>
          </div>
          <hr style="margin:15px 0 0 !important;">
          <div class="forget-password">
            <h4>${local["eaap.op2.portal.login.forgotPassword"]}</h4>
            <p> ${local["eaap.op2.portal.login.forgotPwdOne"]} <a id="forget-password" href="${APP_PATH}/forgotPwd/forgot.shtml"> ${local["eaap.op2.portal.login.forgotPwdTwo"]} </a> ${local["eaap.op2.portal.login.forgotPwdThree"]} </p>
          </div>
