	         ...
	         <div class="panel-body">
	            ...
	            <form class="form-horizontal margin-top-20" role="form" method="post" name="decisionForm" id="decisionForm" action="../messagePortal/submitMsgDecision.shtml">
			        ...
			        <div class="form-group" align="center">
			        	<div class="">
			                  <button type="button" class="btn default" id="decisionFormCancelBtn" data-dismiss="modal">${local["eaap.op2.portal.portalMessage.btn.cancle"] }</button>
			                   <button type="submit" class="btn theme-btn" id="decisionFormSubmitBtn">${local["eaap.op2.portal.portalMessage.btn.submit"] }</button>
			           </div>
			        </div>
                   </div>
			    </form>	
