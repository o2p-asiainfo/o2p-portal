...
import com.ailk.o2p.portal.utils.ObjectUtils;
...
public class JedisUtils {
	private static Logger logger = Logger.getLog(JedisUtils.class);
	...
	public static String get(String key) {
		...
		try {
			...
			logger.error(LogModel.EVENT_APP_EXCPT, new BusinessException(ExceptionCommon.WebExceptionCode,"exception:" + e.getCause(),null));
		} finally {
